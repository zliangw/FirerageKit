...
target :Firerage do
   ...
   pod 'NavigationMenu', :podspec => './PodsSpecs/NavigationMenu.podspec'
   pod 'GCPlaceholderTextView', :podspec => './PodsSpecs/GCPlaceholderTextView.podspec'
   pod 'BButton', :podspec => './PodsSpecs/BButton.podspec'
